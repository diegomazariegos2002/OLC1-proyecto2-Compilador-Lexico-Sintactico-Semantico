...
export class Incremento_Ins extends Instruccion{
    constructor(
    ...
    public execute(env: Environment) {
        ...
        if (variable == null || variable == undefined) {
            ...
            const error = new Excepcion("Error semántico", `el incremento de un NULL no es válido`, this.line, this.column);
            ...
            if(variable?.tipo == Tipo.INT || variable?.tipo == Tipo.DOUBLE){
                ...
                //ERROR
                const error = new Excepcion("Error semántico", `el incremento de un char\\string\\boolean\\NULL no es válido`, this.line, this.column);
                consola.set_Error(error);
            }
        }
    }
